...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-[3px] bg-[#FAFBFF] p-1 text-[#6B7280]",
      className
    )}
    {...props}
  />
