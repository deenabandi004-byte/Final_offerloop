...
const terms = [
  ...
  { term: 'Coffee Chat', id: 'coffee-chat', definition: 'An informal, low-pressure conversation — usually 15-30 minutes over coffee or video call — where a student learns about a professional\'s career path, role, or company. Coffee chats are a core networking strategy in consulting and banking recruiting, often serving as the first step toward getting a referral.' },
  ...
  { term: 'Informational Interview', id: 'informational-interview', definition: 'A structured conversation where a student asks a professional about their career, company culture, and industry — without directly asking for a job. Informational interviews are the professional version of a coffee chat and are especially common in consulting recruiting, where "getting your name in the system" before applications open is critical.' },
  ...
  { term: 'Referral', id: 'referral', definition: 'A recommendation from a current employee that flags your application for special consideration. At most top firms, referred candidates are 3-5x more likely to receive an interview than cold applicants. Getting a referral typically requires building a genuine relationship through coffee chats or informational interviews before asking.' },
