...
// Chrome Web Store item ID (extension ID when published)
const CHROME_WEB_STORE_ITEM_ID = 'ddmpkghhncfkhecannnlalicbbkfhfea';

// OAuth Client IDs (from client_secret JSON - native/installed app)
const CLIENT_IDS = {
  dev: '184607281467-8t6hcfm66efpi7dmff7s27i06rih0mu7.apps.googleusercontent.com',
  prod: '184607281467-8t6hcfm66efpi7dmff7s27i06rih0mu7.apps.googleusercontent.com'
};
