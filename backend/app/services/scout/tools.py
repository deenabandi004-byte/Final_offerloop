...
FIND_HIRING_MANAGERS_TOOL: Dict[str, Any] = {
    ...
    "description": (
        ...
        "honor a count the user gives). ONLY when the user's own words say "
        "hiring manager / recruiter / talent: the database has far more "
        "regular employees than recruiters, so find_contacts is the default "
        "for every other people ask ('employees', 'people', 'someone', "
        "plain role words). Use for 'who's the hiring manager "
